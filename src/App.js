...
let EU_countries=
['AT-sky', 'BE-sky', 'BG-sky', 'HR-sky', 'CY-sky',
 'CZ-sky', 'DK-sky', 'EE-sky','FI-sky', 'FR-sky',
 'DE-sky', 'GR-sky','HU-sky', 'IE-sky', 'IT-sky',
 'LV-sky', 'LT-sky', 'LU-sky','MT-sky', 'NL-sky',
 'PL-sky', 'PT-sky', 'RO-sky', 'SK-sky', 'sl-sky',
'es-sky','se-sky']
...
carribean_countries= ['AG	-	sky','AI	-	sky'	,'AW	-	sky'	,'BB	-	sky'	,'BL	-	sky'	,'BS	-	sky'	,'CU	-	sky']	
...
class App extends Component {
  ...
  getLocalAirports = (origin) => {
    ...
    findFlights = () => {
      ...
      promises.push(this.browseRoutes('anywhere').then((result) => airport_list.push(result)))

      Promise.all(promises)
      .then(()=>(
        this.renderFlights(airport_list)
      ))
    }
